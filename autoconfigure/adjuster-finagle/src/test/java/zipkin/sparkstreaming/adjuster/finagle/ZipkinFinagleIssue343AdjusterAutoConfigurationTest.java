...
import zipkin.sparkstreaming.autoconfigure.adjuster.finagle.ZipkinFinagleIssue343AdjusterProperties;

public class ZipkinFinagleIssue343AdjusterAutoConfigurationTest {
  ...
  public void doesntProvideAdjusterWhenDisabled() {
    context.register(PropertyPlaceholderAutoConfiguration.class,
        ZipkinFinagleIssue343AdjusterProperties.class,
  ...
  public void providesAdjusterWhenEnabled() {
    ...
    assertThat(adjuster.adjustIssue343()).isFalse();
  }

  @Test
  public void enableAdjustIssue343() {
    addEnvironment(context,
        "zipkin.sparkstreaming.adjuster.finagle.enabled:" + true,
    ...
    FinagleIssue343Adjuster adjuster = context.getBean(FinagleIssue343Adjuster.class);
    assertThat(adjuster.adjustIssue343()).isTrue();
  }
}
